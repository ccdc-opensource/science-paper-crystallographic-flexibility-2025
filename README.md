...
Ensure you have a working CSD Python API environment (see the CCDC online documentation <a href="https://downloads.ccdc.cam.ac.uk/documentation/API/">here</a> for more information.) No separate package installation is required beyond dependencies already provided with the API.
